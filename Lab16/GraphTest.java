public class GraphTest
{
	...
	{
		IGraph<String> g = new AdjacencyListGraph<String>();
		...
		g.removeEdge(0, 5);
		System.out.println("EDGE REMOVING");
		...
		compare(new int[] {4}, g.getNeighbors(0));
		compare(new int[] {3, 5}, g.getNeighbors(1));
		compare(new int[] {0, 5, 1}, g.getNeighbors(2));
		compare(new int[] {4, 1}, g.getNeighbors(3));
		compare(new int[] {0, 3}, g.getNeighbors(4));
		compare(new int[] {1}, g.getNeighbors(5));
