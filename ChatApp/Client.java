...
public class Client implements Runnable, IClient
{
	...
	/*	this.addNetworkListener(new ListCommand());
		this.addNetworkListener(new RenameCommand());
		this.addNetworkListener(new SayCommand());
		this.addNetworkListener(new SetHandleCommand());
		this.addNetworkListener(new DisconnectCommand());
		this.addNetworkListener(new BadHandleCommand());
		this.addNetworkListener(new AddCommand());
		this.addNetworkListener(new RemoveCommand());*/
	}
	...
	{
		System.out.println("The str in the client side is " + str);
