...
public class GeneratedButtonList extends ArrayList<ThreadedControlButton>
{
    ...
    protected Map<String, Method> buttonLabelToMethodObjMap = new HashMap<String, Method>();
                    ...
                    extends ThreadedControlButton
    {
        ...
        public void act()
        {
            ...
            catch (InvocationTargetException e)
            {
            	...
            	StackTraceElement[] trace = eCause.getStackTrace();

            	String text = eCause.toString();
            	for (StackTraceElement element : trace)
            	{
            		String elementText = element.toString();
            		if (elementText.startsWith("sun.reflect"))
            			break;
            		text += "\n        at " + elementText;
            	}
            	...
            	try
            	{
            		throw e.getCause(); // throw underlying exception
            	}
            	catch (Throwable ee)
            	{
